...
<?php 
    ...
    //<a href='javascript:void();' class='opcionModificarFacturaCompra btn'><img src='../assets/img/update.png' class='zoomImagen' style='width:20px;heigth:20px;' alt='Eliminar contenido'></a>
