<?php
  ...
  $resultado="";
  foreach ($arraysTabla as $columna) {
    $resultado.='INSERT INTO DetalleFacturaVenta(codigoProducto,cantidadComprado,precioCompra,numeroDocumentoFacturaVenta) VALUES('.$corcheteSimple.$columna[0].$corcheteSimple.','.$columna[2].','.$columna[3].','.$numeroDocumento.');';
    //$queryInsertMultipleConComa.=$resultado;
  }  
