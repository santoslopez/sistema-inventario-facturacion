...
$inputNumeroFacturaProveedor=htmlspecialchars($_POST['inputNumeroFacturaProveedor'],ENT_QUOTES,'UTF-8');
$inputFechaFacturaProveedor=htmlspecialchars($_POST['inputFechaFacturaProveedor'],ENT_QUOTES,'UTF-8');
$selectNitProveedor=htmlspecialchars($_POST['selectNitProveedor'],ENT_QUOTES,'UTF-8');
